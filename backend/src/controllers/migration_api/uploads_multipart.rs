...
pub(in crate::controllers::migration_api) type HandlerResult<T> =
    std::result::Result<T, HandlerError>;

pub(in crate::controllers::migration_api) struct ParsedUpload {
    ...
    pub(in crate::controllers::migration_api) bytes: Vec<u8>,
}
...
pub(in crate::controllers::migration_api) async fn read_multipart(
    headers: &HeaderMap,
