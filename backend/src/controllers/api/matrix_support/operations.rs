...
pub(in crate::controllers::api) struct MatrixClient<'a> {
    pub(in crate::controllers::api) http_client: &'a reqwest::Client,
    pub(in crate::controllers::api) homeserver: &'a str,
    pub(in crate::controllers::api) access_token: &'a str,
}

impl<'a> MatrixClient<'a> {
    pub(in crate::controllers::api) const fn new(
    ...
    pub(in crate::controllers::api) async fn set_display_name(
        &self,
        user_id: &str,
        display_name: &str,
    ...
    pub(in crate::controllers::api) async fn upload_media(
        &self,
        bytes: Vec<u8>,
        content_type: &str,
        filename: &str,
    ...
    pub(in crate::controllers::api) async fn set_avatar_url(
        &self,
        user_id: &str,
        avatar_url: &str,
    ) -> std::result::Result<(), String> {
    ...
    pub(in crate::controllers::api) async fn create_private_room(
        &self,
        room_name: &str,
    ...
    pub(in crate::controllers::api) async fn invite_user_to_room(
        &self,
        room_id: &str,
        user_id: &str,
    ...
    pub(in crate::controllers::api) async fn join_room(
        &self,
        room_id: &str,
    ) -> std::result::Result<(), MatrixRequestError> {
        let encoded_room_id = encode_path_component(room_id);
    ...
    pub(in crate::controllers::api) async fn leave_room(
        &self,
        room_id: &str,
    ) -> std::result::Result<(), MatrixRequestError> {
        let encoded_room_id = encode_path_component(room_id);
