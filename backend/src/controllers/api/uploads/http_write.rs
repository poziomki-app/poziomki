...
pub(in crate::controllers::api) async fn file_upload(
...
pub(in crate::controllers::api) async fn file_upload_presign(
    State(_ctx): State<AppContext>,
    headers: HeaderMap,
...
pub(in crate::controllers::api) async fn file_upload_complete(
    State(_ctx): State<AppContext>,
    headers: HeaderMap,
...
pub(in crate::controllers::api) async fn file_delete(
    State(_ctx): State<AppContext>,
    headers: HeaderMap,
