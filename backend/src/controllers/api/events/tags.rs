...
pub(in crate::controllers::api) async fn resolve_event_tag_ids(
...
pub(in crate::controllers::api) async fn sync_event_tags(
    event_id: Uuid,
    tag_ids: &[Uuid],
...
pub(in crate::controllers::api) async fn maybe_sync_tags(
    event_id: Uuid,
...
pub(in crate::controllers::api) async fn upsert_attendee(
    event_uuid: Uuid,
    profile_id: Uuid,
    status: &str,
) -> std::result::Result<(), crate::error::AppError> {
