...
use crate::controllers::api::state::{AttendeeStatus, DataResponse, EventResponse, ProfilePreview};
use crate::db::models::events::Event;
use events_view_images::resolve_event_images;
use events_view_repo::load_event_batch_context;

pub(in crate::controllers::api) use events_view_attendees::attendee_info;
...
pub(in crate::controllers::api) async fn build_event_responses(
    event_models: &[Event],
    profile_id: &Uuid,
...
pub(in crate::controllers::api) async fn build_event_response(
    event: &Event,
    profile_id: &Uuid,
...
pub(in crate::controllers::api) fn created_event_response(
    data: EventResponse,
