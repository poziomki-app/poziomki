...
pub(in crate::controllers::api) fn is_s3_storage_configured() -> bool {
...
pub(in crate::controllers::api) const fn max_upload_size_bytes() -> usize {
    MAX_UPLOAD_SIZE_BYTES
}

pub(in crate::controllers::api) fn allowed_upload_mime(mime_type: &str) -> bool {
...
pub(in crate::controllers::api) fn validate_magic_bytes(data: &[u8], mime_type: &str) -> bool {
    match mime_type {
...
pub(in crate::controllers::api) fn validate_image_dimensions(
    data: &[u8],
    mime_type: &str,
) -> Result<(), &'static str> {
...
pub(in crate::controllers::api) fn extension_for_mime(mime_type: &str) -> &'static str {
    match mime_type {
        "image/jpeg" => "jpeg",
        "image/png" => "png",
        "image/webp" => "webp",
...
pub(in crate::controllers::api) fn create_upload_filename(mime_type: &str) -> String {
    let ext = extension_for_mime(mime_type);
    let random = Uuid::new_v4().simple().to_string();
    format!("{random}.{ext}")
}

pub(in crate::controllers::api) fn validate_filename(
    filename: &str,
...
pub(in crate::controllers::api) fn parse_upload_context(
    value: Option<&str>,
...
pub(in crate::controllers::api) const fn is_chat_context(context: UploadContext) -> bool {
    matches!(
        context,
