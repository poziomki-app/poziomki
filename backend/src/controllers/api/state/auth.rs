...
pub(in crate::controllers::api) fn extract_bearer_token(headers: &HeaderMap) -> Option<String> {
...
#[derive(Clone, Debug)]
pub(in crate::controllers::api) struct CreatedSession {
    pub(in crate::controllers::api) model: Session,
    pub(in crate::controllers::api) token: String,
}
...
pub(in crate::controllers::api) fn hash_session_token(token: &str) -> String {
    session_token_hash(token)
}

pub(in crate::controllers::api) async fn resolve_session_by_token(
    token: &str,
...
pub(in crate::controllers::api) async fn require_auth_db(
    headers: &HeaderMap,
...
pub(in crate::controllers::api) async fn create_session_db(
    headers: &HeaderMap,
    user_id: i32,
...
pub(in crate::controllers::api) fn session_model_to_view(session: &Session) -> SessionView {
    SessionView {
...
pub(in crate::controllers::api) fn user_model_to_view(user: &User) -> UserView {
    UserView {
