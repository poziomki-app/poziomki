...
pub(in crate::controllers::api) async fn profile_create(
...
pub(in crate::controllers::api) async fn profile_update(
    State(_ctx): State<AppContext>,
    headers: HeaderMap,
    Path(id): Path<String>,
...
pub(in crate::controllers::api) async fn profile_delete(
    State(_ctx): State<AppContext>,
    headers: HeaderMap,
    Path(id): Path<String>,
) -> Result<Response> {
